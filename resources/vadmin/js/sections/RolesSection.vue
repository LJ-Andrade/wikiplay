...
<script>
	...
	export default {
		...
		data () {
			return {
				// Section properties
				sectionTexts: { plural: 'Roles', singular: 'Rol', withArticle: "los roles", new: "Crear Rol",
								askDelete: "Va a eliminar los roles seleccionados", askDeleteItem: "Va a eliminar el rol " },
